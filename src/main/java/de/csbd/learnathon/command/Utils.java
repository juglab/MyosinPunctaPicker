...
//	public Color gradientColor( float dist, float length ) {
//		int color1 = 0xff00FF00;
//		int color2 = 0xffFF0000;
//		int r = ( int ) ( ( int ) ( dist * color1.getRed() + ( length - dist ) * color2.getRed() ) / length );
//
...
//		int a2 = c2.getAlpha();
//
//		Color result = new Color( ( c1.getRed() * a1 + c2.getRed() * a2 ) / ( a1 + a2 ), ( c1.getGreen() * a1 + c2
//				.getGreen() * a2 ) / ( a1 + a2 ), ( c1.getBlue() * a1 + c2.getBlue() * a2 ) / ( a1 + a2 ), ( c1.getAlpha() + c2.getAlpha() ) / 2 );
